...
function groupButtonClass() {
  return "flex w-full items-center justify-between rounded-xl px-4 py-3 font-semibold text-slate-300 hover:bg-slate-800 whitespace-nowrap";
}

  return (
    <aside className="w-72 shrink-0 bg-[#0f172a] p-6 text-white">
      <div className="mb-10">
